...
- [2026-06-23] Tasks are sliced as GitHub issues: #1 PRD; #2 Slice 1 (DONE, walking skeleton); #3 Slice 2 (DONE, Pick endpoint + plain button). Remaining: #4 Slice 3 animation, #5 Slice 4 complete + recently-completed (rolling 24h), #6 Slice 5 cancel, #7 Slice 6 edit, #8 Slice 7 reorder.
