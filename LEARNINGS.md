...
- [2026-06-23] Tasks are sliced as GitHub issues: #1 PRD; #2 Slice 1 (DONE, walking skeleton); #3 Slice 2 (DONE, Pick endpoint + plain button); #4 Slice 3 (DONE, Pick animation); #5 Slice 4 (DONE, complete + recently-completed rolling-24h). Remaining: #6 Slice 5 cancel, #7 Slice 6 edit, #8 Slice 7 reorder.
